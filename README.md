...
[![GitHub Release](https://img.shields.io/github/release/Tom-Bom-badil/four-noks-custom-component.svg)](https://github.com/Tom-Bom-badil/four-noks-custom-component/releases)
[![HACS Default](https://img.shields.io/badge/HACS-Custom-orange.svg)](https://hacs.xyz)
[![License](https://img.shields.io/github/license/Tom-Bom-badil/four-noks-custom-component.svg)](LICENSE)
...
3. Add `https://github.com/Tom-Bom-badil/four-noks-custom-component` with category **Integration**.
